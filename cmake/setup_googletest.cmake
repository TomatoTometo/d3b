...
if (NOT GOOGLETEST_LIB_INSTALLATION_DONE)
  ...
  execute_process(
      COMMAND ${CMAKE_COMMAND} -B build/ -DCMAKE_INSTALL_PREFIX=${GOOGLETEST_LOCATION_FOLDER}/install/ -DBUILD_SHARED_LIBS=OFF
  ...
  execute_process(
    COMMAND ${CMAKE_COMMAND} --install build/ --config ${CMAKE_BUILD_TYPE}
